# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2018-05-11 07:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(blank=True, choices=[(0, '女'), (1, '男')], max_length=5, null=True)),
                ('telephone', models.CharField(blank=True, max_length=11, null=True, unique=True, verbose_name='手机号码')),
                ('avatar', models.FileField(default='./upload/img/default.png', upload_to='./upload/img/', verbose_name='头像')),
        ...
        migrations.AddField(
            model_name='article',
            name='detail',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='blog.ArticleDetail', verbose_name='文章内容'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
